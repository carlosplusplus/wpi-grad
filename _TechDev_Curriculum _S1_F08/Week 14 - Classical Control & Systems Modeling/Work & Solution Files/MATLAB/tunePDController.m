...
function [Kp,Kd,tolerance] = tunePDController(plant,t,m, KpLow, KpHigh, KdLow, KdHigh, c)
    ...
    % with the given precision and finds the ideal gains for either minimum
    % cross coupling or minimum settle time. It plots a criteria point
    % matrix to show the gain relationships. It also returns the ideal
    % gains according to the respective optimization request. 
