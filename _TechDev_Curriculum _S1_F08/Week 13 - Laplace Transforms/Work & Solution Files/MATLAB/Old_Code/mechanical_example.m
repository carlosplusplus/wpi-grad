...
noisessimtime = max([P*tau P/fmax]);
...
tau= 1 / a;
noisesimtime = max([P*tau P/fmax]); % Simulation End Time (s)
fm = 1/tau; % Electrical Characteristic Frequency (Hz)
tr_noise = 1/(N*max([fmax fm fd fn])); % Time Resolution (s)
