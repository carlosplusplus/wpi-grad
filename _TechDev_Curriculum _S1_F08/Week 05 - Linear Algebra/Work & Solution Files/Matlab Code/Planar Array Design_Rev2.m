...
h = 18520;                % Initial height (m)

hpa_gain = 0;             % Amplifier gain in dB

dx = .015;        % Spacing of elements in the x direction.
                   % Based on (L/2) < dx < L where L = lambda_u
...
D = lambda_l / Bw;    % Max directivity = low freq / highest directivity
...
ant_gain = (4*pi*dx*dy)/(lambda_l^2);

hpa_gain = 22 - ant_gain + FSPL;        % Antenna gain in dB
