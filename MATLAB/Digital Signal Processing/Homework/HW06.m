...
legend('Original y(n)', '4 Sig Fig Reduction', '2 Sig Fig Reduction', '1 Sig Fig Reduction');

subplot(2,1,2);

stem (err);

xlabel('RMS Reduction: err(1) = 4 bits, err(2) = 2 bits, err(3) = 1 bit');
ylabel('RMS Error');
title ('RMS Error caused by Bit Reduction on a & b Filter Coefficients');