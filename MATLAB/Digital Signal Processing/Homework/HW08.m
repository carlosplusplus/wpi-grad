...
[b2 a2] = ellip(2,0.25,60,.8,'high');

[H2, w2] = freqz(b2,a2,25);
...
title('Elliptical Filter #1 - Magnitude Response');
grid on;
...
xlabel('Discrete-Time Index');
ylabel('Impulse Response');
title('Elliptical Filter #1 - Impulse Response');
grid on;
...
xlabel('Frequency in radians');
ylabel('Magnitude (in dB)');
title('Elliptical Filter #2 - Magnitude Response');
grid on;
...
xlabel('Discrete-Time Index');
ylabel('Impulse Response');
title('Elliptical Filter #2 - Impulse Response');
grid on;