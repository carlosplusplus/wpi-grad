...
states    =      4;
SNR       =     30;
oversamp  =     60;     % Simulates sampling frequency of 1.288 MHz.
...
freqs = (((0:length(fd_ana_sig)-1)/length(fd_ana_sig))-.5) * oversamp;
...
legend('Noisy IS-95 signal after DDS-VFO','Filtered IS-95 Signal');
