...
bool MCCMTransceiver::Initialize()
{
  ...
  {
    MessageLog::Instance()->
      LogMessage("Socket connection failed in MCCMTransceiver::Initialize()!");
    return false;
  }
...
bool MCCMTransceiver::SendUnknownThreatMessage(float azimuth)
{
  ...
  message.data.azimuth = FloatAzimuthToFixed(azimuth);
...
*
******************************************************************************/
bool MCCMTransceiver::Receive(char* buffer, int numberOfBytes)
{
  bool success;
